...
class Hud(DirectFrame):
    ...
    def __init__(self, base, marklist: list = None) -> None:
        ...
        self.compass_rose.setPos(Vec3(0.3,-0.8))
        ...
        boat.moveTo(Vec3(0.0,-0.4))
        boat.drawTo(Vec3(0.0, 0.7))
        boat.moveTo(Vec3(-0.4,-0.4))
        boat.drawTo(Vec3(0.4,-0.4))
        ...
        self.compass_boat.setPos(Vec3(0.3,-0.8))
        ...
        self.compass_wind.setPos(Vec3(0.3,-0.8))
        ...
        self.compass_sail.setPos(Vec3(0.3,-0.8))
        ...
        self.compass_ref.setPos(Vec3(0.3,-0.8))
    ...
    def update(self, x, y, psi, V, psiw, Vw, ds, others, race_events=None):
        ...
        self.speed_display.text = "speed: {:2.1f} kts".format(V)
        self.sail_display.text = "sail:{:2.0f} deg" .format(ds)
